namespace EnsureThat
{
    public static class ExceptionMessages
    {
        ...
        public static string Collections_HasAllNotNullItems_Failed { get; } = "All items in the collection must be non-null.";
        public static string Collections_HasAllNotDefaultItems_Failed { get; } = "All items in the collection must be non-default.";
